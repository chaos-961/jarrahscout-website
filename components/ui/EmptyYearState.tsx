...
export default function EmptyYearState({ year, nearestYear, onJump }: EmptyYearStateProps) {
  return (
    <motion.div
      ...
      className="pointer-events-auto w-[min(26rem,calc(100vw-2.5rem))] rounded-2xl border border-paper-300 bg-paper-50/92 p-6 text-center shadow-card backdrop-blur-md"
    >
      <span className="mx-auto mb-4 grid h-11 w-11 place-items-center rounded-full bg-paper-200 text-ink-faint">
      ...
      <h3 className="font-display text-xl font-semibold tracking-[-0.01em] text-ink">
        No events recorded in {year}
      </h3>
      <p className="mx-auto mt-2 max-w-[22rem] font-body text-sm leading-relaxed text-ink-muted">

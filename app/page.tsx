...
function MapSkeleton() {
  return (
    <div className="relative h-full w-full overflow-hidden bg-paper-200">
...
export default function HomePage() {
  ...
  const nearestYear = useMemo(() => {
    ...
    return populated.reduce((best, y) =>
  ...
  return (
    <>
      <main className="flex h-[100dvh] flex-col overflow-hidden pt-14">
        ...
        <div className="relative min-h-0 flex-1 border-t border-paper-300">
          {loading ? (
            <MapSkeleton />
          ) : (
            <HeritageMap
